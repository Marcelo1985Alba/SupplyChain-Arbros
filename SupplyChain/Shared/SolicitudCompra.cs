...
[Table("Solicitud")]
public class SolicitudCompra : EntityBase<int>
{
    public DateTime Fecha { get; set; } = DateTime.Now;

    [Required(ErrorMessage = "El Producto es requerido")]
    [StringLength(15, MinimumLength = 3, ErrorMessage = "El producto debe tener entre 3 y 15 digitos")]
    ...
    [Range(1, 9999999, ErrorMessage = "La Cantidad es requerida")]
    ...
    [StringLength(500, ErrorMessage = "*Las observaciones tienen un maximo de 500 caracteres")]
