...
{
    [Key] [Column("REGISTRO")] public new decimal Id { get; set; }

    public string CG_PROG { get; set; }
    public DateTime? FE_PROG { get; set; }

    [Display(Name = "Producto")] public string CG_PROD { get; set; }

    [Display(Name = "Descripción")] public string DES_PROD { get; set; }

    public int CG_FORM { get; set; }

    [Display(Name = "Cantidad")] public decimal CANT { get; set; }
    ...
    [Display(Name = "Pedido")] public int PEDIDO { get; set; }

    [Display(Name = "Cliente")] public int CG_CLI { get; set; }

    public int CG_FLAG { get; set; }

    [Display(Name = "Orden Fabricación")] public int CG_ORDF { get; set; }
