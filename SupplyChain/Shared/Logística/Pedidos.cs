...
public class Pedidos : EntityBase<int?>
{
     ...
     */
    [NotMapped] public bool EXIGEDESPACHO { get; set; } = false;

    [NotMapped] public bool EXIGELOTE { get; set; } = false;

    [NotMapped] public bool EXIGESERIE { get; set; } = false;

    [NotMapped] public decimal? PENDIENTEOC { get; set; } = 0;
     ...
     * EJEM: EN DEV A PROVE
     */
    [NotMapped] public vResumenStock ResumenStock { get; set; } = new();

    [NotMapped] public Cliente Cliente { get; set; } = new();

    [NotMapped] public vProveedorItris Proveedor { get; set; } = new();
     ...
     */
    [NotMapped] [RequireDepositoItem] public int CG_DEP_ALT { get; set; } = 0;
    ...
    [Required(ErrorMessage = "ingresar insumo")]
    public string CG_ART { get; set; } = "";

    [Display(Name = "Nombre artículo")] public string DES_ART { get; set; } = "";
    ...
    [Column("FLAG")] public decimal CONFIRMADO { get; set; }
