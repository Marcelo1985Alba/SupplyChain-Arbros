...
public class FormProductoBase : ComponentBase
{
    ...
    protected List<TipoOptions> TipoData = new()
    {
        new() { Text = "CONVENCIONAL" },
        new() { Text = "BALANCEADA" },
        new() { Text = "DOBLE ANILLO" },
        new() { Text = "PILOTADA" }
    };
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        if (!response_1.Error) unidades = response_1.Response;
...
>>>>>>> parent of 9c2d7ab (07092023 ProductoService con metodo Search y Get, FormProducto metod Actualizar actualizado)
        ...
        await ToastMensajeError(
            $"El insumo con codigo {producto.Id} ya existe.\n\rO El tipo de insumo no es permitidio.");
