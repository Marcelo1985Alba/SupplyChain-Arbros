...
public class PresupuestosBase : ComponentBase
{
    ...
    protected List<MotivosPresupuesto> datamotivospresupuesto = new();
    protected List<Presupuesto> datapresupuesto = new();
    ...
    protected List<object> Toolbaritems = new()
    {
        ...
        new ItemModel
        {
            Text = "Imprimir", TooltipText = "Imprimir presupuesto, condiciones comerciales y datasheet",
            PrefixIcon = "e-print", Id = "Imprimir", Type = ItemType.Button
        },
        //new ItemModel { Text = "Copy", TooltipText = "Copy", PrefixIcon = "e-copy", Id = "copy" },
        "ExcelExport",
        new ItemModel
        {
            Text = "", TooltipText = "Actualizar Grilla", PrefixIcon = "e-refresh", Id = "refresh",
    ...
    public async Task Actualizar(ChangeEventArgs<string, Semaforo> args)
    {
        var presupuesto = await PresupuestoService.ActualizarColor(presup.Id, args.Value);
    }

    public async Task Motivos(ChangeEventArgs<string, MotivosPresupuesto> args)
    {
