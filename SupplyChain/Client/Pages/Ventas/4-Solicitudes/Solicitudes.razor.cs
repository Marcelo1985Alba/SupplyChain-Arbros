...
public class SolicitudesBase : ComponentBase
{
    ...
    protected List<object> Toolbaritems = new()
    {
        ...
        new ItemModel
        {
            Text = "Copia", TooltipText = "Copiar un item para generar una nueva solicitud", PrefixIcon = "e-copy",
            Id = "Copy"
        },
        new ItemModel
        {
            Text = "Imprimir DataSheet", TooltipText = "Imprimir DataSheet", PrefixIcon = "e-print", Id = "Imprimir"
        },
        "ExcelExport",
        new ItemModel
        {
    ...
    protected async Task OnActionBeginHandler(ActionEventArgs<vSolicitudes> args)
    {
        ...
        if (args.RequestType == Action.Add) popupFormVisible = true;
    ...
    protected async Task OnToolbarHandler(ClickEventArgs args)
    {
        ...
        {
            if (args.Item.Id == "grdSol_excelexport") await refGrid.ExportToExcelAsync();
        }
    }
