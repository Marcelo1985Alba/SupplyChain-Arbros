...
public class RemitosBase : ComponentBase
{
    ...
    protected List<object> Toolbaritems = new()
    {
        ...
        new ItemModel
        {
            Text = "Generar Remito", TooltipText = "Generar un nuevo remito a partir de los items seleccionandos",
    ...
    protected async Task OnActionBeginHandler(ActionEventArgs<vEstadoPedido> args)
    {
        ...
        {
            SpinnerVisible = true;
            PedidoSeleccionado = new PedidoEncabezado();
        ...
        if (args.RequestType == Action.BeginEdit)
        {
            ...
            if (!string.IsNullOrEmpty(args.Data.REMITO)) //traer remito
            {
                ...
                else
                {
                    ...
                    foreach (var item in PedidoSeleccionado.Items) item.ESTADO = EstadoItem.Modificado;
