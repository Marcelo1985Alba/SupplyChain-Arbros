...
{
    public partial class AsignacionMenuUsuarioBase : ComponentBase
    {
        ...
        protected bool SpinnerVisibleMenuMaestro = false;
        ...
        public void CheckAll()
        {
            ...
            this.treeviewMaster.CheckAllAsync();
        ...
        public void UncheckAll()
        {
            ...
            this.treeviewMaster.UncheckAllAsync();
        ...
        protected async Task AgregarItemsSeleccionados(MouseEventArgs args)
        {
            ...
            if (idNodes is not null && idNodes.Count > 0)
            {
                ...
                var padreModulosSeleccionados = dbMenuMaster.Where(m => !modulosSeleccionados.Select(s => s.Id).Contains(m.Id) &&
        ...
        public async Task OnChange(Syncfusion.Blazor.DropDowns.ChangeEventArgs<string, vUsuario> args)
        {
