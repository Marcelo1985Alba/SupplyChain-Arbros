...
public class BuscadorEmergenteBase<TItem> : ComponentBase
{
    ...
    [Parameter] public bool MostrarVerMas { get; set; }
    ...
    /// </summary>
    [Parameter]
    public string HeightGrid { get; set; } = "290px";
    ...
    /// </summary>
    [Parameter]
    public EventCallback<TItem> OnObjetoSeleccionado { get; set; }
    ...
    /// </summary>
    [Parameter]
    public bool AplicarFiltro { get; set; }
    ...
    {
        if (args.Item.Id == "ExcelExport") await Grid.ExportToExcelAsync();
    }
