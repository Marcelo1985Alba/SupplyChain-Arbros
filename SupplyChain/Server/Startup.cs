...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        BoldLicenseProvider.RegisterLicense("W2XPSOfZsRxe8tNwDyzLLeSXWmY4ye6r0x2hfMcYxds=");
        SyncfusionLicenseProvider.RegisterLicense(
            "MTA0Njk4NUAzMjMwMmUzNDJlMzBaRFRIcHVVaVJ2K1ZFVTd6TXA4dnRXQ01EVlRTMEpXdXpkTnFUTGdMem9rPQ==");
        ...
        services.AddCors(op =>
        {
            op.AddDefaultPolicy(builder => { builder.AllowAnyOrigin().AllowAnyMethod().AllowAnyHeader(); });
        });
