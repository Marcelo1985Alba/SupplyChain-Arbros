...
public class FilesManagerServiciosController : Controller
{
    ...
    public FilesManagerServiciosController(SolutionRepository solutionRepository,
        AuthenticationStateProvider authenticationStateProvider)
    {
        operation = new PhysicalFileProvider();
        _solutionRepository = solutionRepository;
        root = solutionRepository.Obtener(s => s.CAMPO == "RUTAFOTOSSOL").FirstOrDefault().VALORC;
