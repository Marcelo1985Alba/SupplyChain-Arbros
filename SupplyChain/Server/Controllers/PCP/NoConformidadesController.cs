...
public class NoConformidadesController : ControllerBase
{
    ...
    */
    ...
    {
        var xSQL = string.Format("SELECT Cg_NoConf, noconfor.Cg_TipoNc, tiposnoconf.des_tiponc, " +
    ...
    public async Task<ActionResult<IEnumerable<ModeloPedidosDespacho>>> GetDespachosByOF(decimal cg_ordf)
    {
        ...
        */
        ...
        var xSQL = "SELECT DISTINCT A.DESPACHO FROM Pedidos A " +
    ...
    {
        var xSQL = "SELECT DISTINCT A.LOTE FROM Pedidos A " +
    ...
    {
        var xSQL = "SELECT * FROM Compras A " +
    ...
    {
        var xSQL = "SELECT CAST(A.CG_ORDING AS VARCHAR(10)) AS LOTE FROM Pedidos A " +
    ...
    {
        if (NoConf.Cg_NoConf == 0) return BadRequest("Registro Incorrecto");
    ...
    {
        var xSQL =
            "SELECT a.Cg_NoConfAcc, a.Cg_NoConf, a.Orden, b.Texto as DesOrden, a.Observaciones, a.Fe_ocurrencia, a.Usuario " +
