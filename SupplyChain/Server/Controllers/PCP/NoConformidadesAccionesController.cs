...
public class NoConformidadesAccionesController : ControllerBase
{
    ...
    */
    ...
    public async Task<ActionResult<NoConformidadesAcciones>> DeleteAccion(int Cg_NoConfAcc)
    {
        ...
        if (NoConfAccion == null) return NotFound();
    ...
    [HttpPost]
    public async Task<ActionResult<NoConformidadesAcciones>> PostStock(
        [FromBody] NoConformidadesAcciones NoConfAcciones)
    {
        try
        {
    ...
    */
    ...
    {
        var xSQL = "SELECT * FROM NoConfor_ListaAcciones ";
